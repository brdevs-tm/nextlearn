...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 to-indigo-600/30"></div>
        <motion.div
        ...
        >
          <motion.h1
            className="text-5xl md:text-7xl font-extrabold mb-4 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-indigo-200"
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
          ...
          >
            <Link href="/centers">
              <motion.button
                className="bg-indigo-600 text-white font-semibold py-3 px-8 rounded-full hover:bg-indigo-700 transition-all duration-300"
                whileHover={{
                  scale: 1.1,
            ...
            <Link href="/centers/nearby">
              <motion.button
                className="bg-transparent border-2 border-white text-white font-semibold py-3 px-8 rounded-full hover:bg-white hover:text-indigo-600 transition-all duration-300"
                whileHover={{
                  scale: 1.1,
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          <motion.h2
            className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-gray-200 text-center mb-12 tracking-tight"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          <motion.h2
            className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-gray-200 mb-12 tracking-tight"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8 }}
          >
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
              ...
              <div className="swiper-wrapper">
                {[
                  ...
                  <div key={center.name} className="swiper-slide">
                    <motion.div
                      className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all duration-300"
                    ...
                    >
                      <div className="relative">
                        ...
                        />
                        <motion.div
                          className="absolute top-2 right-2 bg-indigo-600 text-white text-xs font-semibold px-2 py-1 rounded-full"
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
            ...
            <motion.div
              className="centers-swiper-button-prev absolute left-0 md:-left-12 top-1/2 transform -translate-y-1/2 bg-indigo-600 text-white p-3 rounded-full cursor-pointer z-10"
            ...
            <motion.div
              className="centers-swiper-button-next absolute right-0 md:-right-12 top-1/2 transform -translate-y-1/2 bg-indigo-600 text-white p-3 rounded-full cursor-pointer z-10"
              whileHover={{ scale: 1.2, rotate: 10 }}
              whileTap={{ scale: 0.9 }}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            ...
            <motion.div
              className="testimonials-swiper-button-prev absolute left-0 md:-left-12 top-1/2 transform -translate-y-1/2 bg-indigo-600 text-white p-3 rounded-full cursor-pointer z-10"
              whileHover={{ scale: 1.2, rotate: -10 }}
              whileTap={{ scale: 0.9 }}
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            <motion.div
              className="testimonials-swiper-button-next absolute right-0 md:-right-12 top-1/2 transform -translate-y-1/2 bg-indigo-600 text-white p-3 rounded-full cursor-pointer z-10"
              whileHover={{ scale: 1.2, rotate: 10 }}
              whileTap={{ scale: 0.9 }}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                excerpt: "Python va Java kurslari Samarqandda kengaymoqda...",
                date: "10 Apr, 2025",
          ...
          >
            <Link href="/blog">
              <motion.button
                className="bg-transparent border-2 border-indigo-600 text-indigo-600 font-semibold py-3 px-8 rounded-full hover:bg-indigo-600 hover:text-white transition-all duration-300"
                whileHover={{
                  scale: 1.1,
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Link href="/partner">
            <motion.button
              className="bg-white text-indigo-600 font-semibold py-3 px-8 rounded-full hover:bg-gray-100 transition-all duration-300"
              whileHover={{
                scale: 1.1,
                boxShadow: "0 0 20px rgba(255, 255, 255, 0.7)",
              }}
